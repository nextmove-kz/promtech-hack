          ...
          contents: [
            {
              ...
              parts: [
                {
                  text: `AUDIT REQUEST FOR PIPELINE OBJECT: "${analysisData.object.name}"
...
- Actions Completed: ${analysisData.plan?.actions_done} / ${analysisData.plan?.actions_total}
- Actions Log: ${JSON.stringify(analysisData.plan?.actions?.map((a) => a.description))}
