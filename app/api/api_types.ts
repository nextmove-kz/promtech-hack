...
export type ActionResponse<Texpand = unknown> = Required<ActionRecord> &
  BaseSystemFields<Texpand>;
export type DiagnosticsResponse<Texpand = unknown> =
  Required<DiagnosticsRecord> & BaseSystemFields<Texpand>;
export type ObjectsResponse<Texpand = unknown> = Required<ObjectsRecord> &
  BaseSystemFields<Texpand>;
export type PipelinesResponse<Texpand = unknown> = Required<PipelinesRecord> &
  BaseSystemFields<Texpand>;
export type PlanResponse<Texpand = unknown> = Required<PlanRecord> &
  BaseSystemFields<Texpand>;
